...
const Cart = () => {
  ...
  return (
    <div onMouseMove={sumtotal} className='cart'>
      <div className='title'>
        <h2 className='orderid'>Order #2123</h2>
      </div>
            ...
            <div key={data.id} className='order-deatils'>
              <div className='data'>
                ...
                <div className='div'>
                  ...
                  <p className='p-price'><BiRupee/>{data.price}</p>

                </div>
                <div className='quantity'>{data.quantity}</div>
                <div className='quantity1'><p><BiRupee/>{data.quantity*data.price}</p></div>
              </div>
              <div className='input'>
                <input type='text' className="input1" placeholder='write something here..'></input>
